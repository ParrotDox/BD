...
{
    public class GetRepairCostAnalysisVM : ProcedureBaseVM
    {
        ...
        public override SqlCommand? FormQuery()
        {
            ...
            SqlCommand command = new("EXEC sp_GetRepairCostAnalysis @VehicleId, @VehicleType, @VehicleMake, @Year,@Month,@Day");
